...
contract Fund {
    ...
    */
    ...
    /*
    Users can transfer funds to the contract using this method. Before calling this method
    the use has to call the approve method on the CFToken separately otherwise the 
